...
<img alt="" className="img-fluid w-100 rounded mb-5" src="img/wedeveloping gif.gif"/>
...
<div className="section-title section-title-sm position-relative pb-3 mb-5">
...
<div className="center-circle">Web Designing</div>
...
<h4>App Designing &amp; Developing</h4>
...
<div className="card-face front flip-card-front">
<h4>Software Designing &amp; Developing</h4>
<p className="text-success">Hover to learn more</p> </div>

<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">Leverage cutting-edge technology to build scalable and efficient software solutions.</p>
<ul>
<li>Design-Driven Architecture</li>
...
<div className="card-face front flip-card-front">
<h4>Static Webdesign</h4>
<p className="text-success">Hover to learn more</p>
</div>

<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">A static website is a fixed-content web solution where each page is pre-coded and delivered exactly as stored.</p>
<ul>
<li>Fast Loading</li>
...
<div className="card-face front flip-card-front">
<h4>Dynamic Webdesign</h4>
<p className="text-success">Hover to learn more</p>
</div>

<div className="card-face back flip-card-back">
<h3 className="text-primary text-center">What We Do</h3>
<p className="ms-3">Dynamic web design creates interactive and data-driven websites that adapt content in real-time based on user input or backend systems.</p>
<ul>
...
<div className="card-face back flip-card-back">
<h3 className="text-primary text-center">What We Do</h3>
<p className="ms-3">E-commerce is the digital platform for buying and selling products or services online through secure, user-friendly interfaces.</p>
<ul>
...
<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">Website redesign is the process of revamping a siteΓÇÖs structure, visuals, and functionality to improve user experience and performance.</p>
<ul>
<li>Modern UI/UX</li>
<li>SEO &amp; Performance Boost</li>
