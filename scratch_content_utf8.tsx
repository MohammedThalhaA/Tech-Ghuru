...
<div className="mb-5">
<img alt="" className="img-fluid w-100 rounded mb-5" src="img/Services/contentwriting3.avif"/>
<h1 className="mb-4">Content Writing</h1>
...
<div className="center-circle">Content Writting</div>
...
<p className="ms-3"> Write content that is easy to read and understand without confusion..</p>
<ul>
<li>Use plain language and avoid jargon. </li>
<li>Keep sentences and paragraphs short.  </li>
<li>Organize ideas logically and clearly.</li>
</ul>
...
<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3"> Tailor content to the specific needs, preferences, and language of your readers.</p>
<ul>
<li>Research your target audience thoroughly.</li>
<li>Use a tone and style that resonates with them.

</li>
<li>Address their pain points and interests directly.</li>
</ul>
<a className="fancy-button text-center bg-primary ms-3 me-3" href="./contact.html">Get Started</a>
</div>
</div>
...
<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">Structure content to improve search engine ranking and organic visibility.</p>
<ul>
<li>Incorporate relevant keywords naturally.</li>
<li>Use proper headings, meta descriptions, and alt tags.</li>
<li>Optimize for readability and fast page loading.
...
<div className="card-face front flip-card-front">
<h3>Original and Valuable Content</h3>
<p className="text-success">Hover to learn more</p>
</div>

<div className="card-face back flip-card-back">
<h3 className="text-primary text-center">What We Do</h3>
<p className="ms-3">Provide unique and helpful information that stands out and benefits your readers.

.</p>
<ul>
<li>Avoid copying or duplicating existing content. </li>
<li>Share insights, data, or solutions not easily found elsewhere.</li>
<li>Optimize for readability and fast page loading.</li>
</ul>
<a className="fancy-button text-center bg-primary ms-3 me-3" href="./contact.html">Get Started</a>
</div>
</div>
...
<div className="card-face back flip-card-back">
<h3 className="text-primary text-center">What We Do</h3>
<p className="ms-3">A strong structure ensures that a website or application is logically organized, easy to navigate, and supports smooth user interaction..</p>
<ul>
...
<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3"> Use clear, compelling prompts that encourage readers to take desired actions.</p>
<ul>
<li>Make CTAs concise and action-oriented.</li>
<li>Position CTAs prominently within content.</li>
<li>Align CTAs with the contentΓÇÖs purpose and user intent.
