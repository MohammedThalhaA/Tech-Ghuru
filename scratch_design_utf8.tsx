...
<div className="mb-5">
<img alt="" className="img-fluid w-100 rounded mb-5" src="img/Services/product designgif.gif"/>
<h1 className="mb-4">Product Design</h1>
<p>We offers innovative product design services that blend creativity with functionality to bring your ideas to life. Their team focuses on user-centric designs that enhance usability and market appeal. From concept to prototype, they ensure a seamless development process. Ideal for businesses seeking standout, effective product solutions.</p>
...
<div className="center-circle">Product Designing</div>
...
<div className="hidden-sections row container">
...
<p className="ms-3">A user-centered approach focuses on designing products or services based on the needs, preferences, and behaviors of the end users.</p>
<ul>
...
<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">Functionality and usability ensure a product works as intended and is easy for users to interact with effectively.</p>
<ul>
...
<div className="card-face front flip-card-front">
<h3>Aesthetic &amp; Branding</h3>
<p className="text-success">Hover to learn more</p>
</div>

<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">Aesthetic and branding create a visually appealing and consistent identity that reflects the brandΓÇÖs values and attracts users.</p>
<ul>
<li>Visual Consistency</li>
<li>Emotional Connection</li>
<li>Professional Appeal </li>
</ul>
<a className="fancy-button text-center bg-primary ms-3 me-3" href="./contact.html">Get Started</a>
</div>
</div>
...
<p className="ms-3">Innovation and uniqueness drive creative solutions and distinct features that set a product apart in the market.</p>
<ul>
<li>Creative Problem Solving </li>
<li>Distinct Identity</li>
<li>Continuous Improvement</li>
</ul>
<a className="fancy-button bg-primary text-center ms-3 me-3" href="./contact.html">Get Started</a>
</div>
</div>
</div>
<div className="card-scene content-box col-lg-4 flip-card">
...
<div className="card-face front flip-card-front">
<h3>Feasibility &amp; Cost Efficiency</h3>
<p className="text-success">Hover to learn more</p>
</div>

<div className="card-face back flip-card-back">
<h3 className="text-primary text-center">What We Do</h3>
<p className="ms-3">Feasibility and cost efficiency ensure that a project is practical to implement within budget while maximizing value.</p>
<ul>
...
<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">Prototyping and testing involve building early models of a product and evaluating them to ensure functionality, usability, and user satisfaction.</p>
<ul>
<li>Early Feedback Loop</li>
<li>Risk Reduction</li>
<li>User-Centered Refinement </li>
</ul>
<a className="fancy-button bg-primary ms-3 me-3 text-center" href="./contact.html">Get Started</a>
</div>
</div>
</div>
</div>
