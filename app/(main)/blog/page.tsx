...
<a className="h5 text-white" href="">Blog</a>
</div>
</div>
</div>
...
<div className="row g-5">
<div className="col-md-6 wow slideInLeft" data-wow-delay="0.6s">
...
<small className="me-3"><i className="far fa-user text-primary me-2"></i>Anandh</small>
...
<div className="p-4">
<div className="d-flex mb-3">
<small className="me-3"><i className="far fa-user text-primary me-2"></i>Karthick</small>
<small><i className="far fa-calendar-alt text-primary me-2"></i>12 Jan, 2023</small>
</div>
<h5 className="mb-3"><b>Content Writing</b></h5>
<p>Will AI Replace Writers?: What Today's Content Creators and Digital Marketers Should Know.
...
<p>The Art and Science of Influencer Marketing A Definitive Guide to Success
                                </p>
...
<div className="p-4">
<div className="d-flex mb-3">
<small className="me-3"><i className="far fa-user text-primary me-2"></i>Damodhar</small>
<small><i className="far fa-calendar-alt text-primary me-2"></i>12 Jan, 2023</small>
</div>
<h5 className="mb-3"><b>Product Photoshoot</b></h5>
<p>In the ever-evolving realm of product photography, innovative and creative ideas for capturing product images
...
<div className="p-4">
<div className="d-flex mb-3">
<small className="me-3"><i className="far fa-user text-primary me-2"></i>Yadash</small>
<small><i className="far fa-calendar-alt text-primary me-2"></i>12 Jan, 2023</small>
</div>
<h5 className="mb-3"><b>Digital Marketing</b></h5>
...
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="webdevelopingblog.html"><i className="bi bi-arrow-right me-2"></i>Web Developing </a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="productdesignblog.html"><i className="bi bi-arrow-right me-2"></i>Product Design</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="contentwritingblog.html"><i className="bi bi-arrow-right me-2"></i>Content Writing</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="digitalmarketingblog.html"><i className="bi bi-arrow-right me-2"></i>Digital Marketing</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="brandingblog.html"><i className="bi bi-arrow-right me-2"></i>Digital Marketing Strategies</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="videoadblog.html"><i className="bi bi-arrow-right me-2"></i>Video Ads &amp; Photoshoot</a>
</div>
</div>
