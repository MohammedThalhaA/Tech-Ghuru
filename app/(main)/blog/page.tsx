...
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="/blog/web-developing"><i className="bi bi-arrow-right me-2"></i>Web Developing </a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="/blog/product-design"><i className="bi bi-arrow-right me-2"></i>Product Design</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="/blog/content-writing"><i className="bi bi-arrow-right me-2"></i>Content Writing</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="/blog/digital-marketing"><i className="bi bi-arrow-right me-2"></i>Digital Marketing</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="/blog/branding"><i className="bi bi-arrow-right me-2"></i>Digital Marketing Strategies</a>
<a className="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="/blog/video-ads"><i className="bi bi-arrow-right me-2"></i>Video Ads &amp; Photoshoot</a>
</div>
</div>
