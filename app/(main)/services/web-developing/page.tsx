...
<div className="card-face back flip-card-back">
<h3 className="text-center text-primary">What We Do</h3>
<p className="ms-3">Website redesign is the process of revamping a site’s structure, visuals, and functionality to improve user experience and performance.</p>
<ul>
<li>Modern UI/UX</li>
